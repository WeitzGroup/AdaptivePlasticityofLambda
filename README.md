...
## General description:
This repository contains all the code and data needed to generate Figures S2,S3 and S5in the paper "The Adapative Plasticity of Phage Lambda". The code is written in MATLAB 2024a and MATLAB 2025b. 
