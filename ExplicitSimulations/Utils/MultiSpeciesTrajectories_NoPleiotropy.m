%% Multispecies dynamics in the plastic but non-pleiotropic case at MOI = 2.

% This function accepts the oscillation period, predicted coESS strategy
% for the resident, number of cycles and number of strains as parameters. It then computes the 
% population trajectory and saves the output to a file.
...
function MultiSpeciesTrajectories_NoPleiotropy(coESS, period, numstrains, numcycles)
...
filename = sprintf('../Data/MultispeciesDynamics_NoPleiotropy_n=%d,Period=%d,z1=%.2f,z2=%.2f.mat',numstrains, period,coESS(1),coESS(2));
